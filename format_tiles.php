...
$string['showprogresssphototiles_desc'] = 'Wenn diese Option ausgewählt ist, wird der Teilnehmendenfortschritt (z.B. Fortschritt 2/5) auf den Fotokacheln angezeigt.';
