...
$string['bulkuseroperation'] = 'Nutzer*innenverarbeitung (Bulk)';
...
$string['errajaxfailedenrol'] = 'Fehler bei der Nutzer*inneneinschreibung';
$string['errajaxsearch'] = 'Fehler bei der Nutzer*innensuche';
$string['erroreditenrolment'] = 'Fehler bei der Bearbeitung der Nutzer*inneneinschreibung';
$string['errorwithbulkoperation'] = 'Fehler bei der Nutzer*innenverarbeitung (Bulk)';
...
$string['eventuserenrolmentupdated'] = 'Nutzer*inneneinschreibung aktualisiert';
...
$string['extremovedaction_help'] = 'Wählen Sie, welche Aktion ausgeführt werden soll, wenn die Nutzendeneinschreibung aus der externen Einschreibequelle verschwindet. Beachten Sie bitte, dass bei der Kursabmeldung Nutzendendaten und -einstellungen gelöscht werden.';
$string['extremovedkeep'] = 'Nutzer*in eingeschrieben lassen';
$string['extremovedunenrol'] = 'Nutzer*in vom Kurs abmelden';
$string['finishenrollingusers'] = 'Nutzer*inneneinschreibung beenden';
...
$string['privacy:metadata:user_enrolments:modifierid'] = 'ID der Person, der zuletzt die Nutzer*inneneinschreibung geändert hat';
$string['privacy:metadata:user_enrolments:status'] = 'Status der Nutzer*inneneinschreibung im Kurs';
...
$string['privacy:metadata:user_enrolments:timecreated'] = 'Zeitpunkt, zu dem die Nutzer*inneneinschreibung erstellt wurde';
$string['privacy:metadata:user_enrolments:timeend'] = 'Zeitpunkt, zu dem die Nutzer*inneneinschreibung abläuft';
$string['privacy:metadata:user_enrolments:timemodified'] = 'Zeitpunkt, zu dem die Nutzer*inneneinschreibung bearbeitet wurde';
$string['privacy:metadata:user_enrolments:timestart'] = 'Zeitpunkt, zu dem die Nutze*innenreinschreibung beginnt';
$string['recovergrades'] = 'Alte Nutzer*innenbewertungen falls möglich wiederherstellen';
