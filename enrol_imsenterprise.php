...
$string['createnewusers_desc'] = 'Die IMS Enterprise Einschreibungsdatei enthält in der Regel eine Liste von Teilnehmer\\*innen. Mit der Funktion kann für Personen, die noch nicht in Moodle registriert sind, ein Nutzendenkonto angelegt werden. Teilnehmer\\*innen werden zunächst aufgrund der ID-Nummer und dann nach dem Anmeldenamen in Moodle gesucht. Aus dem IMS Enterprise Plugin werden keine Kennwörter importiert. Hierfür wird die Nutzung eines Authentifizierungsplugin empfohlen.';
$string['deleteusers'] = 'Nutzer*innenzugänge löschen, falls so in IMS-Daten definiert';
$string['deleteusers_desc'] = 'Funktion: Mit den IMS-Enterprise-Einschreibungsdaten kann man auch Nutzendenaccounts löschen, indem der "recstatus" auf auf \'3\' gesetzt wird. In Moodle wird der Datensatz des\\*der Nutzers\\*in dann nicht gelöscht, sondern der Flag auf gelöscht gesetzt.';
...
$string['usecapitafix_desc'] = 'Nur für Nutzer\\*innen des Teilnehmendenverwaltungssystems CAPITA: Der XML Output von Capita enthält einen Fehler. Bei Verwendung von Capita sollte diese Einstellung deaktiviert sein.';
