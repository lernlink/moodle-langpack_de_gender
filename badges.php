...
$string['backpackimport_help'] = 'Wenn die Verbindung zum Backpack erfolgreich hergestellt ist, können Badges aus Ihrem Backpack auf der Seite \'Meine Badges\' und in Ihrem Nutzer*innenprofil angezeigt werden. An dieser Stelle können Sie die Badge Collections auswählen, die Sie in Ihrem Profil anzeigen möchten.';
$string['badgeprivacysetting_help'] = 'Sie können erworbene Badges in Ihren Nutzer*innenprofil anzeigen lassen. Diese Einstellung legt fest, ob neue Badges automatisch sichtbar werden. Sie können die Sichtbarkeit eines Badge jederzeit auf der Seite \'Meine Badges\' ändern.';
...
$string['criteria_6_help'] = 'Dieses Kriterium ermöglicht es, die Verleihung eines Badge daran zu knüpfen, dass bestimmte Profilfelder im Nutzer*innenprofil vervollständigt wurden. Das können Standardprofilfelder oder selbst definierte Profilfelder sein.';
...
$string['localbadgesh_help'] = 'Diese Seite zeigt alle Badges, die Ihnen auf dieser Website für den Abschluss von Kursen, Aktivitäten oder anderer Kriterien verliehen wurden. Sie können für Ihre Badges einstellen, welche in Ihrem Nutzer*innenprofil angezeigt werden sollen und welche nicht. Sie können alle oder einzelne Badges herunterladen und auf Ihrem Computer speichern. Heruntergeladene Badges können zu externen Backpack-Diensten hinzugefügt werden.';
...
$string['sitebadges_help'] = 'Website-Badges können nur für systemweite Leistungen verliehen werden, wie z.B. das Abschließen mehrerer Kurse oder die Vervollständigung des Nutzer*innenprofils. Website-Badges können auch manuell von einer Person an eine andere verliehen werden. Badges für kursbezogene Leistungen müssen für den jeweiligen Kurs angelegt werden. Sie finden die entsprechenden kursbezogenen Badges unter \'Kurs-Administration > Badges\'.';
