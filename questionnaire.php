...
$string['privacy:metadata:questionnaire_response:userid'] = 'Die ID des*der Nutzers*Nutzerin für diese Antwort.';
...
$string['required_help'] = 'Wenn Sie **Ja** wählen, ist eine Antwort auf diese Frage obligatorisch, d.h. der\\*die Nutzer\\*in wird die Befragung nicht abgeben können, bis diese Frage beantwortet ist.';
$string['respondenteligiblestudents'] = 'nur Teilnehmer*innen';
$string['respondenteligibleteachers'] = 'nur Trainer*innen';
$string['respondenttype_help'] = 'Sie können die vollständigen Namen der Nutzer\\*innen zu jeder Antwort anzeigen lassen, wenn Sie diese Option auf "mit Namen" setzen. Sie können die Identitäten der Nutzer\\*innen verstecken, wenn Sie diese Option auf "anonym" setzen.';
