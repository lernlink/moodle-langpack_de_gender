...
$string['customcert:manageemailothers'] = 'Die Einstellung "Weitere Empfänger*innen benachrichtigen" anpassen';
...
$string['emailothers'] = 'Weitere Empfänger*innen benachrichtigen';
$string['emailothers_help'] = 'Die hier eingetragenen E-Mail-Empfänger\\*innen (durch Komma getrennt bei mehreren Adressen) erhalten eine Kopie des Zertifikats. <strong>Achtung:</strong> Wenn diese Option eingestellt ist bevor die Erstellung des Zertifikats beendet ist, werden die E-Mail-Empfänger\\*innen ein unvollständiges Zertifikat erhalten.';
...
$string['norecipients'] = 'Kein*e Empfänger*innen';
