...
$string['label:api_user_desc'] = 'Der API Benutzer*inname wird gebraucht, um mit Hilfe des API einen Gutschein zu erstellen.';
...
$string['label:coupon_recipients_help'] = 'Mit diesem Feld können Sie eine CSV-Datei mit Teilnehmer*innendaten hochladen.';
