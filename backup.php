...
$string['choosefilefromuserbackup_help'] = 'Sicherungsdateien mit der Option \'anonymisierte Nutzer\\*inneneinträge\' werden hier gespeichert.';
...
$string['importgeneralduplicateadminallowed_desc'] = 'Wenn es auf dem System einen Nutzer\\*innenaccount mit dem Anmeldenamen \'admin\' gibt, kann es beim Wiederherstellen einer Sicherung einen Konflikt geben, sofern darin ebenfalls ein solcher Nutzer vorhanden ist. Mit dieser Einstellung kann der Konflikt gelöst werden. Es wird dann eine neuer Nutzer\\*innenname \'admin_xyz\' erzeugt.';
$string['includeuserinfo'] = 'Nutzer*innendaten';
$string['keptroles_help'] = 'Wählen Sie aus, welche Nutzer\\*innen mit den ausgewählten Rollen in den neuen Kurs eingeschrieben werden sollen. Es werden keine Nutzer\\*innendaten dupliziert, außer wenn die Option "Nutzer\\*innendaten einbeziehen" ausgewählt ist.';
