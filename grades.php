...
$string['mapfrom_help'] = 'Wählen Sie die Spalte in der Tabelle, die Daten zur Identifizierung des\\*r Nutzers\\*in enthält. Das können sein: Nutzer\\*innenname, Nutzer-ID oder E-Mail-Adresse.';
$string['mygrades_desc'] = 'Die Einstellung fügt den Link zu einer externen Bewertungsverwaltung zum Nutzer\\*innenmenu hinzu.';
...
$string['profilereport_help'] = 'Der Bewertungsbericht wird auf der Seite des Nutzer\\*innenprofils angezeigt.';
...
$string['showuserimage_help'] = 'Nutzer\\*innenbild neben dem Namen in der Bewerter\\*innenübersicht anzeigen';
...
$string['userfields_show_help'] = 'Diese Option legt fest, ob zusätzliche Nutzer\\*innenfelder wie z.B. die E-Mail-Adresse in der Bewerter\\*innenübersicht angezeigt werden. Welche Felder angezeigt werden, wird über die Einstellung showuseridentity gesteuert.';
