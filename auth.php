...
$string['allowaccountssameemail_desc'] = 'Wenn diese Option aktiviert ist, können mehrere Nutzendenkonten die gleiche E-Mail-Adresse verwenden. Probleme hinsichtlich Sicherheit oder Datenschutz könnten entstehen, wenn z.B. eine Bestätigungsmitteilung zur Kennwortänderung versendet wird.';
...
$string['auth_fieldlocks_help'] = '<p>Sie können Datenfelder im Nutzendenprofil sperren. Dies ist sinnvoll, wenn die Nutzendendaten von Administrator\\*innen gepflegt werden, manuell angelegt oder im Bulkupload (Hochladen über Textdatei) hochgeladen werden. Falls Sie von Moodle benötigte Datenfelder sperren, müssen Sie sicherstellen, dass diese Datenfelder beim Anlegen der Nutzendenprofile sinnvoll belegt werden.</p><p>Um Probleme zu vermeiden, achten Sie darauf, dass die Einstellung auf "Bearbeitbar (wenn leer)" gesetzt ist.</p>';
...
$string['chooseauthmethod_help'] = 'Diese Option legt die Authentifizierung für das Nutzendenkonto fest. Hier sollten nur aktive Authentifizierungen angegeben werden, denn sonst kann sich diese Person nicht mehr anmelden. Um ein Nutzendenkonto vorübergehend zu sperren, wählen Sie die Authentifizierung "Kein Login".';
...
$string['selfregistration_help'] = 'Wenn die Selbstregistrierung (z.B. \'E-Mail basiert\') aktiviert ist, können sich alle Personen selbst registrieren und ein Nutzendenkonto anlegen. Auf diese Weise könnten aber auch Spammer ein Nutzendenkonto erhalten und Einträge in Foren, Blogs oder Profilen missbrauchen. Um dieses Risiko zu vermeiden, können Sie die Selbstregistrierung ausschalten oder auf bestimmte E-Mail-Domains (z.B. meinefirma.de) beschränken.';
