...
$string['uploadpictures_help'] = 'Nutzer\\*inbilder können als ZIP-Paket mit mehreren Bilddateien hochgeladen werden. Moodle ordnet die enthaltenen Dateien den Nutzer\\*innenkonten als Portrait zu, wenn die Bilddateien geeignet benannt sind. Wenn Sie als Nutzer\\*inattribut den Nutzer\\*innamen gewählt haben, wird die Bilddatei nutzer1234.jpg für das Nutzer\\*inkonto nutzer1234 verwendet. Zulässige Bilddateitypen sind gif, jpg und png.';
